...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ 
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <div 
        className={`hidden sm:flex items-center bg-brand-white text-brand-black px-3.5 py-2 rounded-full shadow-lg border border-brand-gray text-xs font-medium tracking-normal transition-all duration-300 pointer-events-none ${
