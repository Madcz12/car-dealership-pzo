    ...
    <section id="contacto" className="py-20 bg-brand-navy text-brand-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center">
          <div className="p-6 rounded-xl bg-brand-navy-light/40 border border-brand-navy-light flex flex-col items-center">
          ...
          <div className="p-6 rounded-xl bg-brand-navy-light/40 border border-brand-navy-light flex flex-col items-center">
            <Phone className="w-8 h-8 text-brand-accent mb-3" />
            ...
            <Button variant="accent" size="sm" href="https://wa.me/584140000000" target="_blank">
          ...
          <div className="p-6 rounded-xl bg-brand-navy-light/40 border border-brand-navy-light flex flex-col items-center">
            <svg 
              className="w-8 h-8 text-brand-accent mb-3" 
              viewBox="0 0 24 24" 
              fill="none" 
              stroke="currentColor" 
              strokeWidth="2" 
