...
export const ContactSection: React.FC = () => {
  return (
    <section id="contacto" className="py-20 bg-brand-navy text-brand-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center">
          <div className="p-6 bg-brand-navy-light/40 border border-brand-navy-light flex flex-col items-center">
          ...
          <div className="p-6 bg-brand-navy-light/40 border border-brand-navy-light flex flex-col items-center">
            ...
            <Button variant="navy" size="sm" href="https://wa.me/584140000000" target="_blank" className="border border-white/20">
          ...
          <div className="p-6 bg-brand-navy-light/40 border border-brand-navy-light flex flex-col items-center">
            ...
            <a 
              ...
              className="text-sm font-semibold text-white hover:text-blue-200 hover:underline"
            >
              @venecarspzo
            </a>
          </div>
